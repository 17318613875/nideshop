...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_exam_paper`;
CREATE TABLE `nideshop_exam_paper`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_exam_paper_answer`;
CREATE TABLE `nideshop_exam_paper_answer`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_exam_paper_question_customer_answer`;
CREATE TABLE `nideshop_exam_paper_question_customer_answer`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_message`;
CREATE TABLE `nideshop_message`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_message_user`;
CREATE TABLE `nideshop_message_user`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_question`;
CREATE TABLE `nideshop_question`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `question_type` int(11) NULL DEFAULT NULL,
  `subject_id` int(11) NULL DEFAULT NULL,
  `score` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_subject`;
CREATE TABLE `nideshop_subject`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_task_exam`;
CREATE TABLE `nideshop_task_exam`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `grade_level` int(11) NULL DEFAULT NULL,
  `frame_text_content_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_task_exam_customer_answer`;
CREATE TABLE `nideshop_task_exam_customer_answer`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `task_exam_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_text_content`;
CREATE TABLE `nideshop_text_content`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `nideshop_user_token`;
CREATE TABLE `nideshop_user_token`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
