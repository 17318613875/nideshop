...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_ad` VALUES (1, 1, 1, '合作 谁是你的菜', '', 'http://yanxuan.nosdn.127.net/65091eebc48899298171c2eb6696fe27.jpg', '合作 谁是你的菜', 0, 1, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_admin` VALUES (1, 'admin', 'e244153af45d0e86620e08daa58e8ea4', 'ABCDEF', '::ffff:127.0.0.1', 1505484711, 0, 0, '\'\'', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_goods_gallery` VALUES (677, 1181000, 'http://yanxuan.nosdn.127.net/355efbcc32981aa3b7869ca07ee47dac.jpg', '', 5);
INSERT INTO `nideshop_goods_gallery` VALUES (678, 1181000, 'http://yanxuan.nosdn.127.net/43e283df216881037b70d8b34f8846d3.jpg', '', 5);
...
-- ----------------------------
BEGIN;
INSERT INTO `nideshop_goods_issue` VALUES (1, '1181000', '购买运费如何收取？', '单笔订单金额（不含运费）满88元免邮费；不满88元，每单收取10元运费。\n(港澳台地区需满');
COMMIT;
